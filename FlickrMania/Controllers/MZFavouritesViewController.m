...
- (void)recentCellDidPerformDeleteAction:(MZRecentCell *)recentCell
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:MZRemoveFromFavouritesNotification object:nil];
}
 ...
 heightForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"w: %@, h: %@",photo.smallestDimension.width,photo.smallestDimension.height);
